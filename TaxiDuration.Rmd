...
plot(KMRush, col = c("black", "red"), xlim= c(0,5000), xlab = "Trip Duration (seconds)", ylab = "Survival Estimate", main = "Taxi Trip Duration by Rush Hour")
legend("topright", inset = 0.05, title = "Rush Hour Indicator", legend = c("0", "1"), fill = c('black', 'red'))
