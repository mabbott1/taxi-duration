...
# [1] AVE  ST   BLVD RD   LN   CT        PL   PKWY DR   BRG  EXPY PLZ  LOOP XING CIR  TER  APPR CRES SQ   ALY  WAY 
#[23] WALK PARK EN   HL   TRL  TUNL HTS  FWY  PT   GLN  TPKE EXT  PATH GDNS ROAD HWY  LK   OVAL ROW  RAMP SLIP VLG 
#[45] CLOS N    CRSE RMP  GRN  OPAS VIA  RDG  BL   EXIT ESPL MNR  RDWY DY   BDG  CP 
...
StreetInfo$street <- sub("XING", "CROSSING", StreetInfo$street)
StreetInfo$street <- sub("APPR", "", StreetInfo$street)
StreetInfo$street <- sub("CRES", "", StreetInfo$street)
StreetInfo$street <- sub("SQ", "", StreetInfo$street)
StreetInfo$street <- sub("ALY", "", StreetInfo$street)
StreetInfo$street <- sub("WAY", "", StreetInfo$street)
StreetInfo$street <- sub("WALK", "", StreetInfo$street)
StreetInfo$street <- sub("PARK", "", StreetInfo$street)
StreetInfo$street <- sub("EN", "", StreetInfo$street)
StreetInfo$street <- sub("HL", "", StreetInfo$street)
StreetInfo$street <- sub("TRL", "", StreetInfo$street)
StreetInfo$street <- sub("TUNL", "", StreetInfo$street)
StreetInfo$street <- sub("HTS", "", StreetInfo$street)
StreetInfo$street <- sub("FWY", "", StreetInfo$street)
StreetInfo$street <- sub("PT", "", StreetInfo$street)
StreetInfo$street <- sub("GLN", "", StreetInfo$street)
StreetInfo$street <- sub("TPKE", "", StreetInfo$street)
StreetInfo$street <- sub("EXT", "", StreetInfo$street)
StreetInfo$street <- sub("PATH", "", StreetInfo$street)
StreetInfo$street <- sub("GDNS", "", StreetInfo$street)
StreetInfo$street <- sub("ROAD", "", StreetInfo$street)
StreetInfo$street <- sub("HWY", "", StreetInfo$street)
StreetInfo$street <- sub("LK", "", StreetInfo$street)
StreetInfo$street <- sub("OVAL", "", StreetInfo$street)
StreetInfo$street <- sub("ROW", "", StreetInfo$street)
StreetInfo$street <- sub("RAMP", "", StreetInfo$street)
StreetInfo$street <- sub("SLIP", "", StreetInfo$street)
StreetInfo$street <- sub("VLG", "", StreetInfo$street)
StreetInfo$street <- sub("CLOS", "", StreetInfo$street)
StreetInfo$street <- sub("N", "", StreetInfo$street)
StreetInfo$street <- sub("CRSE", "", StreetInfo$street)
StreetInfo$street <- sub("RMP", "", StreetInfo$street)
StreetInfo$street <- sub("GRN", "", StreetInfo$street)
StreetInfo$street <- sub("OPAS", "", StreetInfo$street)
StreetInfo$street <- sub("VIA", "", StreetInfo$street)
StreetInfo$street <- sub("RDG", "", StreetInfo$street)
StreetInfo$street <- sub("BL", "", StreetInfo$street)
StreetInfo$street <- sub("EXIT", "", StreetInfo$street)
StreetInfo$street <- sub("ESPL", "", StreetInfo$street)
StreetInfo$street <- sub("MNR", "", StreetInfo$street)
StreetInfo$street <- sub("RDWY", "", StreetInfo$street)
StreetInfo$street <- sub("DY", "", StreetInfo$street)
StreetInfo$street <- sub("BDG", "", StreetInfo$street)
StreetInfo$street <- sub("CP", "", StreetInfo$street)
...
## Creating Bike Lane Vector


```{r}

RoadsData = data.frame(TaxiRoutes$street_for_each_step_1, TaxiRoutes$street_for_each_step_2,TaxiRoutes$street_for_each_step_3,TaxiRoutes$street_for_each_step_4,TaxiRoutes$street_for_each_step_5,TaxiRoutes$street_for_each_step_6,TaxiRoutes$street_for_each_step_7,TaxiRoutes$street_for_each_step_8,TaxiRoutes$street_for_each_step_9,TaxiRoutes$street_for_each_step_10,TaxiRoutes$street_for_each_step_11,TaxiRoutes$street_for_each_step_12,TaxiRoutes$street_for_each_step_13,TaxiRoutes$street_for_each_step_14,TaxiRoutes$street_for_each_step_15,TaxiRoutes$street_for_each_step_16,TaxiRoutes$street_for_each_step_17,TaxiRoutes$street_for_each_step_18,TaxiRoutes$street_for_each_step_19,TaxiRoutes$street_for_each_step_20,TaxiRoutes$street_for_each_step_21,TaxiRoutes$street_for_each_step_22,TaxiRoutes$street_for_each_step_23,TaxiRoutes$street_for_each_step_24,TaxiRoutes$street_for_each_step_25,TaxiRoutes$street_for_each_step_26,TaxiRoutes$street_for_each_step_27,TaxiRoutes$street_for_each_step_28,TaxiRoutes$street_for_each_step_29,TaxiRoutes$street_for_each_step_30,TaxiRoutes$street_for_each_step_31,TaxiRoutes$street_for_each_step_32,TaxiRoutes$street_for_each_step_33,TaxiRoutes$street_for_each_step_34,TaxiRoutes$street_for_each_step_35,TaxiRoutes$street_for_each_step_36,TaxiRoutes$street_for_each_step_37,TaxiRoutes$street_for_each_step_38,TaxiRoutes$street_for_each_step_39,TaxiRoutes$street_for_each_step_40,TaxiRoutes$street_for_each_step_41,TaxiRoutes$street_for_each_step_42,TaxiRoutes$street_for_each_step_43,TaxiRoutes$street_for_each_step_44,TaxiRoutes$street_for_each_step_45,TaxiRoutes$street_for_each_step_46,)
